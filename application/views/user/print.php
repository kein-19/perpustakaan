                ...
                <div class="card-header">
                    <div class="row">
                        <div class="row col-sm-9 col-md-10">
                            ...
                            <div class="col-sm-12 ml-md-4 align-self-sm-center">
                                <h3 class="font-weight-bold text-dark">Nomor Formulir <?= $tbl_siswa_baru['kode_pendaftaran']; ?></h3>
                            </div>
                        </div>
                        <div class="row ml-md-4">
                            <!-- <div class="float-sm-right"> -->
                            <img src="<?= base_url('assets/img/profile/') . $tbl_siswa_baru['image']; ?>" class=" img-thumbnail" style="width: 150px">
                        </div>

                        <!-- <div class="row col-md-10">
                    <h1 class="col-md-12 ml-md-4 font-weight-bold text-primary align-self-md-center p-2"><?= $title; ?></h1>
                    <h2 class="col-md-12 ml-md-4 ">Nomor Formulir : <?= $tbl_siswa_baru['kode_pendaftaran']; ?></h2>
                </div> -->
